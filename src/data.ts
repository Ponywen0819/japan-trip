...
export const days: Day[] = [
  ...
  },
  {
    ...
    summary: '上午逛東茶屋街與金澤21世紀美術館，下午兼六園＋金澤城（三者緊鄰），晚上回片町林暮大酌館小酌。',
    slots: [
      {
        start: '09:30',
        end: '11:00',
      ...
      },
      {
        ...
        type: 'stay',
        text: '兼六園',
        note: '新綠、霞之池、徽軫石燈籠（緊鄰美術館）',
        links: [{ label: '兼六園', url: mapSearch('Kenrokuen Garden') }],
      },
      {
        start: '16:00',
        end: '17:00',
      ...
      },
      {
        ...
        text: '晚餐 林暮大酌館',
        note: '片町小酌',
        links: [{ label: '林暮大酌館', url: mapSearch('林暮大酌館 金沢') }],
      },
    ],
    tips: [],
  },
