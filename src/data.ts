  ...
  },
  {
    ...
    slots: [
      ...
      },
      {
        ...
        text: '搭車回難波/心齋橋',
        note: '公園黃昏拍照',
        links: [{ label: '🧭 路線 大阪城→難波', url: mapDir('Osaka Castle Park', 'Namba Station Osaka') }],
      },
      {
        start: '18:00',
        end: '19:30',
  ...
  },
  {
    ...
    slots: [
      ...
      { start: '11:30', end: '12:00', type: 'meal', text: '午餐', note: '大阪出發前吃' },
      {
        ...
        type: 'move',
        text: '心齋橋 → 京都站',
        note: '御堂筋線到新大阪/梅田轉 JR，約 50 分',
        links: [{ label: '🧭 路線 心齋橋→京都站', url: mapDir('Shinsaibashi Station Osaka', 'Kyoto Station') }],
      },
      {
        start: '13:20',
        end: '13:40',
        type: 'move',
        text: '京都站寄行李',
        note: '置物櫃 ¥700／B1 Crosta 人工寄物',
        links: [{ label: '京都站', url: mapSearch('Kyoto Station') }],
      },
      {
        start: '13:45',
        end: '17:00',
        ...
        note: '出町柳',
        links: [
          { label: '鴨川三角洲', url: mapSearch('Kamogawa Delta Demachiyanagi') },
          { label: '🧭 路線 京都站→出町柳', url: mapDir('Kyoto Station', 'Kamogawa Delta') },
        ],
      },
      {
        start: '17:30',
        ...
        type: 'move',
        text: '特急雷鳥號 → 敦賀轉北陸新幹線 → 金澤',
        note: '回京都站取行李，約 2 小時餘',
        links: [{ label: '🧭 路線 京都→金澤', url: mapDir('Kyoto Station', 'Kanazawa Station') }],
      },
      {
        start: '20:00',
        end: '20:30',
